...
To freeze layers, use `--freeze_encoder_layers 0-N`. Results in the paper are based on `N=4` for base and `N=11` for large models. Note that you may remove `--overwrite_cache` to make data loading faster.
